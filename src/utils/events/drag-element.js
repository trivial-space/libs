goog.provide('ts.utils.events.DragElement');
 ...
 */
ts.utils.events.DragElement = function(element) {
    ts.utils.events.DragElement.base(this, 'constructor');
...
goog.inherits(ts.utils.events.DragElement, goog.events.EventTarget);


goog.scope(function() {

    var DragElement = ts.utils.events.DragElement;
