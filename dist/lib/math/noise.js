...
export function tileNoise(width, height, dx, dy) {
    ...
    for (var y = 0; y < height; y++) {
        for (var x = 0; x < width; x++) {
            var s = x / width, t = y / height, nx = Math.cos(s * 2 * Math.PI) * dx / (2 * Math.PI), ny = Math.cos(t * 2 * Math.PI) * dy / (2 * Math.PI), nz = Math.sin(s * 2 * Math.PI) * dx / (2 * Math.PI), nw = Math.sin(t * 2 * Math.PI) * dy / (2 * Math.PI);
