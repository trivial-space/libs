...
export function getYawQuat (quat: quat | number[], rotYAngle: number): quat {
	rotYAngle *= 0.5
	quat[0] = 0
...
export function getPitchQuat (quat: quat | number[], rotXAngle: number): quat {
	rotXAngle *= 0.5
...
export function getRollQuat (quat: quat | number[], rotZAngle: number): quat {
	rotZAngle *= 0.5
	quat[0] = 0
	quat[1] = 0
